...
try {
    ...
    Write-Host 'OK - DeviceManager module loaded successfully' -ForegroundColor Green
}
catch {
    Write-Host 'ERROR - Failed to load DeviceManager module' -ForegroundColor Red
...
Write-Host "  Logs\quas-multi-$logDate.log" -ForegroundColor Gray
Write-Host ''
